...
public partial class @InputControls: IInputActionCollection2, IDisposable
{
    ...
    private List<ITochScreenActions> m_TochScreenActionsCallbackInterfaces = new List<ITochScreenActions>();
    ...
    public struct TochScreenActions
    {
        ...
        public void AddCallbacks(ITochScreenActions instance)
        {
            if (instance == null || m_Wrapper.m_TochScreenActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_TochScreenActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(ITochScreenActions instance)
        {
            @SingleTouch.started -= instance.OnSingleTouch;
            @SingleTouch.performed -= instance.OnSingleTouch;
            @SingleTouch.canceled -= instance.OnSingleTouch;
        ...
        public void RemoveCallbacks(ITochScreenActions instance)
        {
            if (m_Wrapper.m_TochScreenActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(ITochScreenActions instance)
        {
            foreach (var item in m_Wrapper.m_TochScreenActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_TochScreenActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
