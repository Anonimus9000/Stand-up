...
public class ActionFieldData
{
    ...
    [SerializeField] private List<ActionRewardData> _actionRewards;
    ...
    public ActionFieldData(Sprite actionIcon,string actionTitle, float actionTime, List<ActionRewardData> actionRewards)
    {
